...
{   
    ...
    parser->version = (WBXMLVersion)version;
...
static WBXMLError parse_charset(WBXMLParser *parser)
{
    ...
    if (!wbxml_charset_get_name((WBXMLCharsetMIBEnum)charset, &charset_name)) {
...
static WBXMLError parse_element(WBXMLParser *parser)
{
    ...
    if (tag & WBXML_TOKEN_WITH_ATTRS) {
        ...
        do {
            ...
            if ((attrs = (WBXMLAttribute**)wbxml_realloc((void*)attrs,
