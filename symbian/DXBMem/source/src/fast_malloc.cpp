...
//#define SUPPORT_DEBUG_PRINT_MEM
//#define SUPPORT_DEBUG_PRINT_MEM_FILE

#if defined (SUPPORT_DEBUG_PRINT_MEM) && defined (SUPPORT_DEBUG_PRINT_MEM_FILE)
#   define DPMEM(MESS); DPF(MESS);
#   define DPMEMA(MESS, LIST...); DPFA(MESS, LIST);
#   define DPMEMU(MESS, LIST...); DPFU(MESS, LIST);
#elif defined SUPPORT_DEBUG_PRINT_MEM
#   define DPMEM(MESS); DP(MESS);
#   define DPMEMA(MESS, LIST...); DPA(MESS, LIST);
#   define DPMEMU(MESS, LIST...); DPU(MESS, LIST);
#elif defined SUPPORT_DEBUG_PRINT_MEM_FILE
#   define DPMEM(MESS); DF(MESS);
#   define DPMEMA(MESS, LIST...); DFA(MESS, LIST);
#   define DPMEMU(MESS, LIST...); DFU(MESS, LIST);
#else
#   define DPMEM(MESS);
#   define DPMEMA(MESS, LIST...);
#   define DPMEMU(MESS, LIST...);
#endif
// end ---
...
#define MORECORE_DEFAULT chunkMoreCore
// end ---
...
#define dlmalloc_max_footprint fast_malloc_max_footprint
...
#define MMAP_DEFAULT(s)         symbian_mmap(s)
#define MUNMAP_DEFAULT(a, s)    symbian_munmap((a), (s))
#define DIRECT_MMAP_DEFAULT(s)  symbian_mmap(s)
// end ---
#else
#ifndef WIN32
...
void *chunkMoreCore(int size)
{
    ...
    if (size > 0) {
        ...
        DPMEMA("chunk size: %d", rchunk.Size());
...
void log_abort( const char* file, unsigned int line)
{
    ...
    DPMEMA("Abort at %S line %d", &des, line);
    User::After( 500000 );
...
void fast_post_check()
{
    ...
    int shrink_size = ( /*MemoryManager::Status() == ENoOOM*/ true ) ?
