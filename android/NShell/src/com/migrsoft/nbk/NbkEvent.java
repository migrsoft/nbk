...
public class NbkEvent {
	...
	public static final int EVENT_SCREEN_CHANGED = 3;
	public static final int EVENT_GO_FORWARD = 4;
	public static final int EVENT_GO_BACK = 5;
	...
	public static final int EVENT_PROGRESS_DOC = 201;
	public static final int EVENT_PROGRESS_PIC = 202;
	public static final int EVENT_NEW_DOC_BEGIN = 203;
	...
	public static final int EVENT_NO_BACK = 400;
	...
	public int getProgressCurr() {
		return mProgressCurr;
	}
